...
## [0.7.0](https://github.com/sergiodelgadotech/kotlin-saas-starter/compare/v0.6.0...v0.7.0) (2026-07-02)
...
* **billing:** nullable externalCustomerId + ensureStripeCustomer ([#93](https://github.com/sergiodelgadotech/kotlin-saas-starter/issues/93)) ([7bf505d](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/7bf505d7c5f02cc6ef00a9af1e4bd5620ee32f17))
...
* **organization:** add avatarUrl to Member and updateAvatarUrl to MemberRepository ([#98](https://github.com/sergiodelgadotech/kotlin-saas-starter/issues/98)) ([e9fba2a](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/e9fba2a4e859031b828e81d50f6ba90d46c8edc7))
...
* **billing:** add syncFromStripe and shared mapper to fix Starter→Pro upgrade ([cd490cf](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/cd490cf4a3be8916da0fa8bdf4d7985b68b48bf3))
* **billing:** mark subscription not-new before save so updates UPDATE not INSERT ([#90](https://github.com/sergiodelgadotech/kotlin-saas-starter/issues/90)) ([be554af](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/be554afba2225a71156d51dad38b2f379ad10ad8))
...
* **deps:** update all non-major dependencies to v12.10.0 ([#99](https://github.com/sergiodelgadotech/kotlin-saas-starter/issues/99)) ([b7752ce](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/b7752ce612ba93c76d6dc578c5b656112749b991))
* **deps:** update all non-major dependencies to v12.9.0 ([#81](https://github.com/sergiodelgadotech/kotlin-saas-starter/issues/81)) ([602e143](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/602e1437aca00e635371e407204a8903661798da))
* **deps:** update all non-major dependencies to v8.7.0 ([#84](https://github.com/sergiodelgadotech/kotlin-saas-starter/issues/84)) ([4b7d16c](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/4b7d16c47ee90fab359798ab800b3f4970631b88))
* **deps:** update dependency com.stripe:stripe-java to v33.1.0 ([#94](https://github.com/sergiodelgadotech/kotlin-saas-starter/issues/94)) ([cf53bde](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/cf53bde929337ff0b614bc861f48f2f4211fef37))
...
* **deps:** update dependency org.jobrunr:jobrunr-spring-boot-4-starter to v8.7.1 ([#96](https://github.com/sergiodelgadotech/kotlin-saas-starter/issues/96)) ([56fc729](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/56fc7290751986c753a35cc5e900789cd68d73a6))
* **deps:** update dependency org.postgresql:postgresql to v42.7.12 ([#97](https://github.com/sergiodelgadotech/kotlin-saas-starter/issues/97)) ([2019bbc](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/2019bbc0989809e38a44e950fa61913dc6f8fe48))
...
* switch to PR-based workflow with branch protection ([#82](https://github.com/sergiodelgadotech/kotlin-saas-starter/issues/82)) ([ea930eb](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/ea930ebd4f2609a21136a65b6054b721e7eac82e))
