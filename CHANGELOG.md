...
## [1.0.0](https://github.com/sergiodelgadotech/kotlin-saas-starter/compare/v0.5.0...v1.0.0) (2026-05-27)


### ⚠ BREAKING CHANGES

* **autoconfigure:** auth.jwks-url and auth.issuer have moved to saasstarter.security.jwks-url and saasstarter.security.issuer.
...
* **autoconfigure:** add SecurityAutoConfiguration and WebAutoConfiguration (Plan 8) ([69a4725](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/69a4725cadfd368e0237a824f382d452afd45fbb))
...
* **test:** move TestBootApp out of organization package to avoid duplicate JDBC repo scan ([a6eb63a](https://github.com/sergiodelgadotech/kotlin-saas-starter/commit/a6eb63a8911dd14e62853695263e94f3be7f12d4))
